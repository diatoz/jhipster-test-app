...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_QUESTIONMASTER_LIST actions', async () => {
    ...
    it('dispatches FETCH_QUESTIONMASTER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_QUESTIONMASTER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_QUESTIONMASTER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_QUESTIONMASTER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_QUESTIONMASTER actions', async () => {
      const expectedActions = [
        {
